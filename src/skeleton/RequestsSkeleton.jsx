      ...
      {requests.slice(0, 2).map((request, index) => (
        ...
        >
          <div className="flex flex-row gap-2 items-center px-2 py-2 pb-2">
            <div className="h-10 w-10 rounded-md object-cover bg-gray-400"></div>
            <label className="text-xs font-semibold ">
              <span className="text-xs font-light bg-gray-400 animate-pulse"></span>
            </label>
          </div>
          <div className="flex flex-row justify-between px-2 animate-pulse">
            <button className="rounded-md text-sm font-bold bg-gray-400 text-white p-2 w-24"></button>
            <button className="rounded-md text-sm font-bold bg-gray-400 border text-black p-2 w-24 animate-pulse"></button>
          </div>
        </div>
      ))}
    </section>
